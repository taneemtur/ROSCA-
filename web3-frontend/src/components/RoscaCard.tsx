...
const RoscaCard = (props:any) => {
    ...
    // // console.log("Max Users: ",max_participants)
    ...
    // // const parsed = JSON.parse(JSON.stringify(participant))
    ...
    return (
    <div> 
        {/* <button style={{background:'aqua', padding:'10px', margin:'8px'}} onClick={handleClick}>GetInfo</button>  */}
